...
'''
#Load model 
load_model = pickle.load(bz2.BZ2File(r"C:\Users\Khaledseif166\Downloads\All  Of ME\Self-Study-Courses\CDSP_Deploma\Final_Project\Airline_passenger\model.pkl","rb"))
